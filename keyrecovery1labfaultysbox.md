# Multiple Persisten Faults Attack - KeyRecovery1 - For Given Faulty Sboxes from The Laboratory
...
```python
for i in range(256):
    if true_sb[i] != sb_look_up_8bytes_faults[i]:
        print("%3d --> %3d" % (true_sb[i], sb_look_up_8bytes_faults[i]))
```
...
def generate_input_data_for_key_recovery(number_of_faults, number_of_known_ciphertexts):
    ...
    last_round_key = [last_round_key[j][i] for j in range(4) for i in range(4)]
    #faulty_aes.apply_fault(number_of_faults)
    faulty_aes.apply_fault_lab(number_of_faults)
...
true_and_retrievd_last_round_keys, output_dict =\
     compute_avg_cnt_for_wrong_and_correct_keys(number_of_faults=6, number_of_independent_experiments=1)
```

    Number of faults: 6, Number of known ciphertexts: 1526, Number of key candidates: 256
    ----------------- START KEY RECOVERY -----------------
    Number of faults:  6, Candidate No:       0 /     256 - Experiment No:   0 /   1
    Number of faults:  6, Candidate No:      50 /     256 - Experiment No:   0 /   1
    Number of faults:  6, Candidate No:     100 /     256 - Experiment No:   0 /   1
    Number of faults:  6, Candidate No:     150 /     256 - Experiment No:   0 /   1
    Number of faults:  6, Candidate No:     200 /     256 - Experiment No:   0 /   1
    Number of faults:  6, Candidate No:     250 /     256 - Experiment No:   0 /   1
    Time used by key recovery: 24.11 Seconds
